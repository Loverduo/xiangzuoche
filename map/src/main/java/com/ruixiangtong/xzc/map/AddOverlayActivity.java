...
public class AddOverlayActivity extends Activity implements OnClickListener {
    ...
    // 经纬度
    private double latitude = 34.776326;
    private double longitude = 113.616461;
    ...
    // GroundOptions
    // 构建marker图标
    BitmapDescriptor bitmapFocuse = BitmapDescriptorFactory
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bdMap.setMapStatus(MapStatusUpdateFactory.newLatLng(localPoint));
        ...
        bdMap.setOnMapClickListener(new OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                OverlayOptions option = new MarkerOptions().position(latLng).icon(bitmapFocuse);
                // 在地图上添加Marker，并显示
